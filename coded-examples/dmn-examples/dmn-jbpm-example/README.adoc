...
== Project 'dmn-jbpm-parent' details
...
* Define all model
dmn-jbpm-functions::
* Contains the xref:dmn-jbpm-parent/dmn-jbpm-functions/src/main/java/com/redhat/cop/pam/example3/CustomerFunctions.java[function] that will be invoked from DMN in this example
```java
...
dmn-jbpm-services-api::
* Define the services API endpoint
dmn-jbpm-services-api-impl::
* Implements all services defined in *dmn-jbpm-services-api*
...
|xref:dmn-jbpm-parent/dmn-jbpm-model/src/main/java/com/redhat/cop/pam/example3/Customer.java[Customer.java]
|xref:dmn-jbpm-parent/dmn-jbpm-model/src/main/java/com/redhat/cop/pam/example3/CanOpenAccountResults.java[CanOpenAccountResults.java]
|===

dmn-jbpm-kie-api::
* Define a method to invoke the DMN
dmn-jbpm-kie-api-embedded-impl::
* Show how invoke a DMN service from a process embed in your application(Implements the methods defined in *dmn-jbpm-kie-api*)
dmn-jbpm-kie-api-remote-impl::
* Show how invoke a DMN service from a process deployed on a remote kie-server(Implements the methods defined in *dmn-jbpm-kie-api*)
dmn-jbpm-kjar::

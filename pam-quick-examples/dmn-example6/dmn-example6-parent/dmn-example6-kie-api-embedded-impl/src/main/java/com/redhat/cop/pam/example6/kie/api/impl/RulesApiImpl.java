...
import com.redhat.cop.pam.example6.kie.api.utils.KieContainerUtils;
...
public class RulesApiImpl implements RulesApi {
    ...
    public CanOpenAccountResults canOpenAccount(final Customer customer) {
        ...
        final ProcessInstance processInstance  = kieSession.startProcess("dmn-example6-kjar.customer-can-open-account", processParameters);

...
public class RulesApiImpl implements RulesApi {
    ...
    private static final String NAMESPACE = "https://pam.cop.redhat.com/example1/dmn";

    private static final String MODEL_NAME = "customer-can-open-account";

    private static final String CONTAINER_ID = "com.redhat.cop.pam:example1-kjar:1.0";

...
|xref:https://github.com/redhat-cop/businessautomation-cop/tree/master/pam-quick-examples/dmn-examples/dmn-jbpm-ext-kjar-example#build-test-run[README.adoc]

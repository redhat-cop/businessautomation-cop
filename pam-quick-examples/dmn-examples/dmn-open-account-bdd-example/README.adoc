...
|xref:dmn-open-account-bdd-example/dmn-open-account-bdd-model/src/main/java/com/redhat/cop/pam/example5/Customer.java[Customer.java]
|xref:dmn-open-account-bdd-example/dmn-open-account-bdd-model/src/main/java/com/redhat/cop/pam/example5/CanOpenAccountResults.java[CanOpenAccountResults.java]
|===
